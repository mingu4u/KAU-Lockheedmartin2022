...
class LoadImages:
    ...
    def __init__(self, path, frame=None,img_size=640, stride=32, auto=True, transforms=None, vid_stride=1):
        files = []
        images = [frame]
        videos = []
